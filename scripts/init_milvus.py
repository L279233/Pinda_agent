...
def build_schema(client: MilvusClient):
    ...
    schema.add_field("position_id",      DataType.VARCHAR, max_length=64)
...
def build_index_params(client: MilvusClient):
    ...
    ip.add_index(field_name="position_id", index_type="INVERTED")
    ip.add_index(field_name="document_type", index_type="INVERTED")
    return ip
