...
if __name__ == '__main__':
    # qc = QueryClassifier(model_path="/Users/ligang/PycharmProjects/LLM/EduAgent/backend/models/classifier/all-MiniLM-L6-v2")
    # # # 训练并保存到 models/classifier
    # qc.train(
    #     data_path="/Users/ligang/PycharmProjects/LLM/EduAgent/backend/core/data/training_data.jsonl",
    #     output_dir="/Users/ligang/PycharmProjects/LLM/EduAgent/backend/models/classifier/query-classifier-finetuned",
    #     epochs=8,
    #     batch_size=64,
    # )
    from backend.core.logger import configure_logging
    configure_logging()
    print(get_query_classifier().classify("什么是AI"))
    print(get_query_classifier().classify("AI学科的课程大纲包括哪些主要模块"))
